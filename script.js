...
var nApertures = 3; //The number of apertures
var nDots = [30,100,300]; //Number of dots per set (equivalent to number of dots per frame)
var nSets = 1; //Number of sets to cycle through per frame
var coherentDirection = 0; //The direction of the coherentDots in degrees. Starts at 3 o'clock and goes counterclockwise (0 == rightwards, 90 == upwards, 180 == leftwards, 270 == downwards), range 0 - 360
...
var apertureWidth = 200; // How many pixels wide the aperture is. For square aperture this will be the both height and width. For circle, this will be the diameter.
var apertureHeight = 100; //How many pixels high the aperture is. Only relevant for ellipse and rectangle apertures. For circle and square, this is ignored.
var dotColor = "white"; //Color of the dots
var backgroundColor = "gray"; //Color of the background
var apertureCenterX = [window.innerWidth/2,(window.innerWidth/2)-300,(window.innerWidth/2)+300]; // The x-coordinate of center of the aperture on the screen, in pixels
